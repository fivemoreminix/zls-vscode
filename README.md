...
[Installation instructions for ZLS](https://github.com/zigtools/zls#installation) can be found on the ZLS `README.md`. Once you run `zig build config` it will walk you through configuring ZLS for Visual Studio Code and your installation of Zig.
